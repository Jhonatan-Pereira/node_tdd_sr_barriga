...
describe('Ao salvar uma transferência válida...', () => {
  ...
  test('A transação de entreda deve ser positiva', () => {
...
describe('Ao tentar salvar uma transferência inválida', () => {
  ...
  test('Não deve inserir sem descrição', () => template({ description: null }, 'description é um atributo obrigatório'))
  test('Não deve inserir sem valor', () => template({ ammount: null }, 'ammount é um atributo obrigatório'))
  test('Não deve inserir sem data', () => template({ date: null }, 'date é um atributo obrigatório'))
  test('Não deve inserir sem conta de origem', () => template({ acc_ori_id: null }, 'acc_ori_id é um atributo obrigatório'))
  test('Não deve inserir sem conta de destino', () => template({ acc_dest_id: null }, 'acc_dest_id é um atributo obrigatório'))
